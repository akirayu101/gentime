...
eg_thisyear_dict = ['السنه', 'العام', 'هذه السنة', 'هذه السنه', 'هذه العام']
th_thisyear_dict = ['ปีนี้', '2557', '2014',
                    'ปี57', 'ปี14', 'ปี2557', 'ปี2014', '2013']
pt_thisyear_dict = ['deste ano', '2014', '2013']
